...
<sub>Made by [ASO screenshot tool](https://shotlingo.com) — Shotlingo, AI-powered App Store screenshot localization for 40+ languages. Found a wrong expansion estimate? [Open an issue](https://github.com/AlperenGuntekin/text-expansion-calculator/issues).</sub>
